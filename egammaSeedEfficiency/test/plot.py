...
def main(options, paths):
    ...
    nSimHitsL1 = r.TH1F("nSimHitsL1",";Number of Simulated BPIX Hits in Layer1 ",6,0,6) 
    nSimHitsL2 = r.TH1F("nSimHitsL2",";Number of Simulated BPIX Hits in Layer2",6,0,6) 
    nSimHitsL3 = r.TH1F("nSimHitsL3",";Number of Simulated BPIX Hits in Layer3",6,0,6) 
    nSimHitsL4 = r.TH1F("nSimHitsL4",";Number of Simulated BPIX Hits in Layer4",6,0,6) 
    nSimHitsFPIX = r.TH1F("nSimHitsFPIX",";Number of FPIX Layers with Hits",6,0,6) 
    nSimHitsL1FPIX = r.TH1F("nSimHitsL1FPIX",";Number of Simulated FPIX Hits in Layer1 ",6,0,6) 
    nSimHitsL2FPIX = r.TH1F("nSimHitsL2FPIX",";Number of Simulated FPIX Hits in Layer2",6,0,6) 
    nSimHitsL3FPIX = r.TH1F("nSimHitsL3FPIX",";Number of Simulated FPIX Hits in Layer3",6,0,6) 
    nSimHitsL4FPIX = r.TH1F("nSimHitsL4FPIX",";Number of Simulated FPIX Hits in Layer4",6,0,6) 
